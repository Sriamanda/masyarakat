...
<head>
  ...
  <title>Aplikasi Masyarakat</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Aplikasi Masyarakat</b></span>
    </a>
...
<!-- <========================================================================================> -->    
      ...
      <li><a href="<?php echo site_url('RT/DataRT'); ?>"><i class="fa fa-users"></i> <span>Ketua RT</span></a></li>

      <li><a href="<?php echo site_url('Kartu/DataKartu'); ?>"><i class="fa fa-address-card"></i> <span>Kartu Keluarga</span></a></li>

      <li><a href="<?php echo site_url('Warga/DataWarga'); ?>"><i class="fa fa-child"></i> <span>Data Warga</span></a></li>

      <li><a href="<?php echo site_url('Ronda/DataRonda'); ?>"><i class="fa fa-list"></i> <span>Hari Ronda</span></a></li>
     ...
     <?php }elseif ($this->session->userdata('level') == "admin"){?>
      ...
      <li><a href="<?php echo site_url('AKartu/DataKartu'); ?>"><i class="fa fa-address-card"></i> <span>Kartu Keluarga</span></a></li>

      <li><a href="<?php echo site_url('AWarga/DataWarga'); ?>"><i class="fa fa-child"></i> <span>Data Warga</span></a></li>
