...
<div class="row">
      ...
      <a href="<?php echo site_url('Warga/VFormAddWarga'); ?>" class="btn btn-primary btn-sm fa fa-plus"> Tambah Data</a><br><br>
    ...
    <td><img src="<?php echo base_url('images/').$ReadDS->image; ?>" width="60"></td>
		...
		<td width="5%">
			<a href="<?php echo site_url('Warga/DataWarga/'.$ReadDS->id_warga.'/view') ?>">Update</a>
      <td>
      <a href="<?php echo site_url('Warga/DeleteDataWarga/'.$ReadDS->id_warga) ?>">Delete</a>
		</td>
	</tr>
